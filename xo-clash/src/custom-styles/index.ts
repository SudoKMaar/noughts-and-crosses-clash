...
const GameContainer = styled.div`
  ...
  background: linear-gradient(white, white) padding-box,
    linear-gradient(to right, #fceabb, #f8b500) border-box;
...
const BoardContainer = styled.div`
  ...
  .board-row {
    ...
    &:nth-child(1) > div:nth-child(1) {
      ...
      animation: 1s ease-in-out 0s 1 slideInFromTopLeft;
    ...
    &:nth-child(1) > div:nth-child(3) {
      ...
      animation: 1s ease-in-out 0.1s 1 slideInFromTopRight;
    ...
    &:nth-child(3) > div:nth-child(1) {
      ...
      animation: 1s ease-in-out 0.2s 1 slideInFromBottom;
    ...
    &:nth-child(3) > div:nth-child(3) {
      ...
      animation: 1s ease-in-out 0.3s 1 slideInFromTop;
    ...
    &:nth-child(2) > div:nth-child(2) {
      border-bottom-right-radius: 10px;
      animation: 1s ease-in-out 0.7s 1 slideInFromZ;
...
const SquareContainer = styled.div`
  ...
  background: linear-gradient(white, white) padding-box,
    linear-gradient(to right, #fceabb, #fbb500) border-box;
  font-size: 10vh;
  font-weight: bold;
  cursor: pointer;
  position: relative;
